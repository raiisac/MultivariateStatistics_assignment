...
#summary SEM results
sum_sem1$pe[49:51,] %>% 
  mutate (Regression_coefficient = sprintf("%s%s%s",lhs, op, rhs),
          stars = stars.pval(pvalue),
...
Since an anova test for the two SEMs has a p-value of `r round(anovasemp,3)`, we cannot reject the null hypothesis that the models are the same, meaning this new, simpler SEM fits as well as the more elaborate model.
