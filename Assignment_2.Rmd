...
When fitting the common dimnsion hddc models on the training data, with a 3-cluster  model specified as "AkjBkQkD" or "AkjBQkD", dimensions from 2 to 6, we can see that the best performing model is "AkjBQkD" with 4 dimensions (ARI = 0.937). 
 
In addition, when fitting the Mclust models "VVE","VEV","EVV","VVV" on the first 2 to 6 unstandardized principal components, we can see that the best performing model is "VVE" fitted on 6 principal components (ARI = 0.9306558). Comparatively, the best hddc model outperforms the Mclust model.
