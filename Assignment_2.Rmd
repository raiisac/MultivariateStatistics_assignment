...
#test the difference between centroids
boxM_test(data = College_logtranfskewed_centered, group = "Private")
boxM_test(data = College_centered, group = "Private")
boxM_test(data = College_logtranfskewed_std, group = "Private")
boxM_test(data = College_std, group = "Private")
